...
loads-runner --test-dir=/home/rfk/repos/mozilla/identity/picl-idp --test-runner='./loadtest/runner.js {test}' '/home/rfk/repos/mozilla/identity/picl-idp/loadtest/loadtests.js' --hits 10
